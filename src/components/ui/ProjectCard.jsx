        ...
        <article className="group card-project h-[440px] card-interactive hover:shadow-lg hover:shadow-black/20">
            ...
            {/* Footer Section */}
                <div className="mt-auto pt-3">
                    <a
                    href={href}
                    className="inline-block text-sm text-white/75 underline-offset-4 hover:underline focus-visible:outline-none focus-visioble:ring-2 flocus-visible:ring-white/40 rounded"
                    >
                        View Details &rarr;
                    </a>
                </div>
