        ...
        <Section className="py-12 sm:py-16" aria-labelledby="techstack-heading">
            <Container>
                <header className="text-center">
                    <h2 id="techstack-heading" className="heading-section">My Tech Stack</h2>
                    <h3 className="mt-2 subheading-muted">Tools I've been using lately</h3>
                </header>
            {/* Tech Stack Grid */}
            <ul role="lists" className="mt-8 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6 place-items-center">
                {
                    techstack.map((tech) => {
                            ...
                            <li key={tech.id} className="text-center">
                                ...
                                >
                                    ...
                                    <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-xl hover-scale">
                                        {IconComponent && (
                                            <IconComponent 
                                            className="h-12 w-12 opacity-70 group-hover:opacity100 transition-opacity duration-300"
