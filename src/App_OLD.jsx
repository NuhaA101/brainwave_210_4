    ...
    <div className="min-h-full flex items-center justify-center p-6">
      <div className= "max-w-xl w-full text-center bg[--color-card] border border-white/10 p-8 rounded-2xl backdrop-blur-sm">
        <h1 className= {`${textSize} font-semibold text-white`}>
          ...
          <div className="mt-6">
            <button className={`${color} ${rounded} px-6 py-3 text-white font-medium transition focus:outline-none focus:ring-2 focus:ring-indigo-400`}>
              Tailwind Button
            </button>
          </div>
          {/* Controls Grid */}
