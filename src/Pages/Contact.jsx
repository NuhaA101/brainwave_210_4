...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xnnleeob", {
        method: "POST",
        headers: {
  ...
  return (
    <Section>
      <SEO
        title="Contact"
        description="Get in touch with Nuha for your next project. Ready to work together on creating amazing digital experiences."
        url="/contact"
      />
